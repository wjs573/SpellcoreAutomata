    ...
    public class RPGCamera : MonoBehaviour, IRPGCamera {
        ...
        public virtual void InitializeInputActions(bool logWarnings = false) {
            ...
            if (_playerInput.actions == null) {
                Debug.LogWarning("There is no Input Action Asset assigned to the Player Input component on game object " + gameObject.name + "! This is a requirement for the RPG Camera to work properly");
                return;
            }
        ...
        protected virtual void GetInputs() {
            if (!UseLegacyInputSystem) {
                ...
                // Zoom input
                _inputZoomAmount = Utils.TryGetAxis(Utils.InputPhase.Smoothed, "Mouse ScrollWheel");
