    ...
    public class RPGController : MonoBehaviour, IRPGController {
        ...
        public virtual void InitializeInputActions(bool logWarnings = false) {
            ...
            if (_playerInput.actions == null) {
                Debug.LogWarning("There is no Input Action Asset assigned to the Player Input component on game object " + gameObject.name + "! This is a requirement for the RPG Controller to work properly");
                return;
            }
