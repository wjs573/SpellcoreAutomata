...
namespace WJS
{
    ...
    {///<summary>
        ...
        public void AttrRecheck()
        {
            ...
            if (GetComponent<UnitBackpack>() != null)
            {
                equipmentProp += GetComponent<UnitBackpack>().GetEquipmentChaProperty();
            }
        ...
        public void PlaySightEffect(string bindPointKey, string effect, string effectKey = "", bool loop = false)
        {
            ...
            bindPoints.AddBindGameObject(bindPointKey, effect, effectKey, loop);
        }
