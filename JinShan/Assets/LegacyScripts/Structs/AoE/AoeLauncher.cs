...
public struct AoeModel
{
    ...
    )
    {
        ...
        this.onCreate = onCreate == "" ? null : new EventManager<AoeOnCreate>(DesignerScripts.AoE.onCreateFunc[onCreate]);//DesignerScripts.AoE.onCreateFunc[onCreate];
        this.onCreateParams = onCreateParam;
        this.onRemoved = onRemoved == "" ? null : new EventManager<AoeOnRemoved>(DesignerScripts.AoE.onRemovedFunc[onRemoved]);
        this.onRemovedParams = onRemovedParam;
        this.onTick = onTick == "" ? null : new EventManager<AoeOnTick>(DesignerScripts.AoE.onTickFunc[onTick]);
        this.onTickParams = onTickParam;
        this.onChaEnter = onChaEnter == "" ? null : new EventManager<AoeOnCharacterEnter>(DesignerScripts.AoE.onChaEnterFunc[onChaEnter]);
        this.onChaEnterParams = onChaEnterParam;
        this.onChaLeave = onChaLeave == "" ? null : new EventManager<AoeOnCharacterLeave>(DesignerScripts.AoE.onChaLeaveFunc[onChaLeave]);
        this.onChaLeaveParams = onChaLeaveParam;
        this.onBulletEnter = onBulletEnter == "" ? null : new EventManager<AoeOnBulletEnter>(DesignerScripts.AoE.onBulletEnterFunc[onBulletEnter]);
        this.onBulletEnterParams = onBulletEnterParam;
        this.onBulletLeave = onBulletLeave == "" ? null : new EventManager<AoeOnBulletLeave>(DesignerScripts.AoE.onBulletLeaveFunc[onBulletLeave]);
