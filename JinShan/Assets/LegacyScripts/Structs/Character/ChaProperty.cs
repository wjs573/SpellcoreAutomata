...
public struct ChaProperty
{
    ...
    public ChaProperty(
        ...
        int hp = 0, int hp_recover = 0, int mp = 0, int mp_recover = 0, int shield = 0,
        int attack = 0, int defence = 0, int mind = 0,
    ...
    public static ChaProperty operator *(ChaProperty a, ChaProperty b)
    {
        return new ChaProperty(
            ...
            Mathf.RoundToInt(a.shield * (1.0000f + Mathf.Max(b.shield / 100f, -0.9999f))),
            ...
            Mathf.RoundToInt(a.mind * (1.0000f + Mathf.Max(b.mind / 100f, -0.9999f))),
    ...
    public string GetDescription()
    {
        ...
        if (mind != 0)
        {
            description.AppendLine("神魂强度:    " + FormatAttribute(mind));
        }
...
public class ChaResource
{
    ...
    public ChaResource(int hp, int mp = 0, int shield = 0, int mind = 0)
    {
        this.hp = hp;
        this.mp = mp;
        this.shield = shield;
    ...
    public bool Enough(ChaResource requirement)
    {
        return (
            ...
            this.shield >= requirement.shield &&
            this.mind >= requirement.mind
        );
    }
    ...
    public static ChaResource operator *(ChaResource a, float b)
    {
        return new ChaResource(
            ...
            Mathf.FloorToInt(a.shield * b),
            Mathf.FloorToInt(a.mind * b)
        );
    }
    ...
    public static ChaResource operator *(float a, ChaResource b)
    {
        return new ChaResource(
            ...
            Mathf.FloorToInt(b.shield * a),
            Mathf.FloorToInt(b.mind * a)
        );
    }
    ...
    public static ChaResource operator *(ChaResource a, ChaResource b)
    {
        return new ChaResource(
            ...
            Mathf.RoundToInt(a.shield * (1.0000f + Mathf.Max(b.shield, -0.9999f))),
            Mathf.RoundToInt(a.mind * (1.0000f + Mathf.Max(b.mind, -0.9999f)))
        );
    }
